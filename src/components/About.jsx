    ...
    <section id="about" className="p-10 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          I'm a passionate developer with experience building web applications using
          React, Tailwind CSS, and other modern libraries. I enjoy turning
          ideas into reality and continuously learning new technologies.
        </p>
